angular.module('SmartChurchPanel').factory('PontoDePregacaoIgreja', function ($localstorage, $q, $http, ApiEndpoint) {
    ...
    var create = function(dados) {
        ...
        $http
            .post(ApiEndpoint.url+'/pontosdepregacao/create', data, {
                headers: {
    ...
    var edit = function(id, dados) {
        ...
        var deferred = $q.defer();
        $http
            .put(ApiEndpoint.url+'/pontosdepregacao/edit/'+id, data, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
    ...
    var changeStat = function(id, dados) {
        ...
        var deferred = $q.defer();
        $http
            .put(ApiEndpoint.url+'/pontosdepregacao/changestat/'+id, data, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
    ...
    var getMe = function(id) {
        ...
        $http
            .get(ApiEndpoint.url+'/pontosdepregacao/me?id='+id, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
    ...
    var getAll = function(page, pagesize, searchBy, orderBy, groupBy, stat, igreja) {
        ...
        $http
            .get(ApiEndpoint.url+'/pontosdepregacao/all?page='+pg+'&pageSize='+ps+'&searchBy='+sb+
    ...
    var remove = function(id) {
        ...
        var deferred = $q.defer();
        $http
            .delete(ApiEndpoint.url+'/pontosdepregacao/remove/'+id, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
    ...
    var removeAll = function(dados) {
        ...
        var deferred = $q.defer();
        $http
            .post(ApiEndpoint.url+'/pontosdepregacao/removeAll', data, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
