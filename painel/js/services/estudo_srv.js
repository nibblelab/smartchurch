angular.module('SmartChurchPanel').factory('Estudo', function ($localstorage, $q, $http, ApiEndpoint) {
    ...
    var create = function(dados) {
        ...
        $http
            .post(ApiEndpoint.url+'/estudos/create', data, {
                headers: {
    ...
    var createForIgreja = function(dados) {
        ...
        var deferred = $q.defer();
        $http
            .post(ApiEndpoint.url+'/estudos/createForIgreja', data, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
    ...
    var edit = function(id, dados) {
        ...
        var deferred = $q.defer();
        $http
            .put(ApiEndpoint.url+'/estudos/edit/'+id, data, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
    ...
    var changeStat = function(id, dados) {
        ...
        var deferred = $q.defer();
        $http
            .put(ApiEndpoint.url+'/estudos/changestat/'+id, data, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
    ...
    var getMe = function(id) {
        ...
        $http
            .get(ApiEndpoint.url+'/estudos/me?id='+id, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
    ...
    var getDownload = function(id) {
        ...
        $http
            .get(ApiEndpoint.url+'/estudos/download?id='+id, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
    ...
    var getAll = function(page, pagesize, searchBy, orderBy, groupBy, stat, igreja, serie, autor, anexo, video, destinatarios) {
        ...
        $http
            .get(ApiEndpoint.url+'/estudos/all?page='+pg+'&pageSize='+ps+'&searchBy='+sb+
    ...
    var remove = function(id) {
        ...
        $http
            .delete(ApiEndpoint.url+'/estudos/remove/'+id, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
    ...
    var removeAll = function(dados) {
        ...
        var deferred = $q.defer();
        $http
            .post(ApiEndpoint.url+'/estudos/removeAll', data, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
