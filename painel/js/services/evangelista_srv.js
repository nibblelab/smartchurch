angular.module('SmartChurchPanel').factory('Evangelista', function ($localstorage, $q, $http, ApiEndpoint) {
    ...
    var create = function(dados) {
        ...
        $http
            .post(ApiEndpoint.url+'/evangelistas/create', data, {
                headers: {
    ...
    var edit = function(id, dados) {
        ...
        var deferred = $q.defer();
        $http
            .put(ApiEndpoint.url+'/evangelistas/edit/'+id, data, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
    ...
    var changeStat = function(id, dados) {
        ...
        var deferred = $q.defer();
        $http
            .put(ApiEndpoint.url+'/evangelistas/changestat/'+id, data, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
    ...
    var getMe = function(id) {
        ...
        $http
            .get(ApiEndpoint.url+'/evangelistas/me?id='+id, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
    ...
    var getAll = function(page, pagesize, searchBy, orderBy, groupBy, stat, igreja, disponibilidade, pessoa,
        ...
        $http
            .get(ApiEndpoint.url+'/evangelistas/all?page='+pg+'&pageSize='+ps+'&searchBy='+sb+
    ...
    var remove = function(id) {
        ...
        var deferred = $q.defer();
        $http
            .delete(ApiEndpoint.url+'/evangelistas/remove/'+id, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
    ...
    var removeAll = function(dados) {
        ...
        var deferred = $q.defer();
        $http
            .post(ApiEndpoint.url+'/evangelistas/removeAll', data, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
