angular.module('SmartChurchPanel').factory('Cliente', function ($localstorage, $q, $http, ApiEndpoint) {
    ...
    var create = function(dados) {
        ...
        $http
            .post(ApiEndpoint.url+'/clientes/create', data, {
                headers: {
    ...
    var edit = function(id, dados) {
        ...
        var deferred = $q.defer();
        $http
            .put(ApiEndpoint.url+'/clientes/edit/'+id, data, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
    ...
    var changeStat = function(id, dados) {
        ...
        var deferred = $q.defer();
        $http
            .put(ApiEndpoint.url+'/clientes/changestat/'+id, data, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
    ...
    var getMe = function(id) {
        ...
        $http
            .get(ApiEndpoint.url+'/clientes/me?id='+id, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
    ...
    var checkIsCliente = function(email) {
        
        var token = $localstorage.get('token');
        var deferred = $q.defer();
        
        $http
            .get(ApiEndpoint.url+'/clientes/checkIsCliente?email='+email, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
    ...
    var checkClienteForTemplo = function(templo) {
        
        var token = $localstorage.get('token');
        var deferred = $q.defer();
        
        $http
            .get(ApiEndpoint.url+'/clientes/checkClienteForTemplo?igreja='+templo, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
    ...
    var getAll = function(page, pagesize, searchBy, orderBy, groupBy, stat, sinodo, presbiterio, igreja) {
        ...
        $http
            .get(ApiEndpoint.url+'/clientes/all?page='+pg+'&pageSize='+ps+'&searchBy='+sb+
    ...
    var remove = function(id) {
        ...
        var deferred = $q.defer();
        $http
            .delete(ApiEndpoint.url+'/clientes/remove/'+id, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
    ...
    var removeAll = function(dados) {
        ...
        var deferred = $q.defer();
        $http
            .post(ApiEndpoint.url+'/clientes/removeAll', data, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
    ...
    return {
        ...
        getMe: getMe,
        checkIsCliente: checkIsCliente,
        checkClienteForTemplo: checkClienteForTemplo,
        getAll: getAll,
        remove: remove,
        removeAll: removeAll
    };
