angular.module('SmartChurchPanel').factory('SalaEBD', function ($localstorage, $q, $http, ApiEndpoint) {
    ...
    var create = function(dados) {
        ...
        $http
            .post(ApiEndpoint.url+'/salasebd/create', data, {
                headers: {
    ...
    var edit = function(id, dados) {
        ...
        var deferred = $q.defer();
        $http
            .put(ApiEndpoint.url+'/salasebd/edit/'+id, data, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
    ...
    var changeStat = function(id, dados) {
        ...
        var deferred = $q.defer();
        $http
            .put(ApiEndpoint.url+'/salasebd/changestat/'+id, data, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
    ...
    var getMe = function(id) {
        ...
        $http
            .get(ApiEndpoint.url+'/salasebd/me?id='+id, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
    ...
    var getAll = function(page, pagesize, searchBy, orderBy, groupBy, stat, igreja) {
        ...
        $http
            .get(ApiEndpoint.url+'/salasebd/all?page='+pg+'&pageSize='+ps+'&searchBy='+sb+
    ...
    var remove = function(id) {
        ...
        var deferred = $q.defer();
        $http
            .delete(ApiEndpoint.url+'/salasebd/remove/'+id, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
    ...
    var removeAll = function(dados) {
        ...
        var deferred = $q.defer();
        $http
            .post(ApiEndpoint.url+'/salasebd/removeAll', data, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
