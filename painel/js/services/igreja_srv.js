angular.module('SmartChurchPanel').factory('Igreja', function ($localstorage, $q, $http, ApiEndpoint) {
    ...
    var create = function(dados) {
        ...
        $http
            .post(ApiEndpoint.url+'/igrejas/create', data, {
                headers: {
    ...
    var edit = function(id, dados) {
        ...
        var deferred = $q.defer();
        $http
            .put(ApiEndpoint.url+'/igrejas/edit/'+id, data, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
    ...
    var changeStat = function(id, dados) {
        ...
        var deferred = $q.defer();
        $http
            .put(ApiEndpoint.url+'/igrejas/changestat/'+id, data, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
    ...
    var getMe = function(id) {
        ...
        $http
            .get(ApiEndpoint.url+'/igrejas/me?id='+id, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
    ...
    var getAll = function(page, pagesize, searchBy, orderBy, groupBy, stat, sinodo, presbiterio) {
        ...
        $http
            .get(ApiEndpoint.url+'/igrejas/all?page='+pg+'&pageSize='+ps+'&searchBy='+sb+
                        '&orderBy='+ob+'&groupBy='+gb+'&stat='+st+'&sinodo='+sn+'&presbiterio='+pb, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
    ...
    var remove = function(id) {
        ...
        var deferred = $q.defer();
        $http
            .delete(ApiEndpoint.url+'/igrejas/remove/'+id, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
    ...
    var removeAll = function(dados) {
        ...
        var deferred = $q.defer();
        $http
            .post(ApiEndpoint.url+'/igrejas/removeAll', data, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
