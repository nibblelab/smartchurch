angular.module('SmartChurchPanel').factory('MembroDaIgreja', function ($localstorage, $q, $http, ApiEndpoint) {
    ...
    var create = function(dados) {
        ...
        $http
            .post(ApiEndpoint.url+'/membros/create', data, {
                headers: {
    ...
    var edit = function(id, dados) {
        ...
        var deferred = $q.defer();
        $http
            .put(ApiEndpoint.url+'/membros/edit/'+id, data, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
    ...
    var changeStat = function(id, dados) {
        ...
        var deferred = $q.defer();
        $http
            .put(ApiEndpoint.url+'/membros/changestat/'+id, data, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
    ...
    var getMe = function(id) {
        ...
        $http
            .get(ApiEndpoint.url+'/membros/me?id='+id, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
    ...
    var getAssociacaoByPessoa = function(pessoa) {
        ...
        $http
            .get(ApiEndpoint.url+'/membros/associacaobypessoa?pessoa='+pessoa, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
    ...
    var check = function(pessoa, igreja) {
        ...
        $http
            .get(ApiEndpoint.url+'/membros/check?pessoa='+pessoa+'&igreja='+igreja, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
    ...
    var getAll = function(page, pagesize, searchBy, orderBy, groupBy, stat, igreja, comungante, nao_comungante, especial, 
        ...
        $http
            .get(ApiEndpoint.url+'/membros/all?page='+pg+'&pageSize='+ps+'&searchBy='+sb+
    ...
    var remove = function(id) {
        ...
        var deferred = $q.defer();
        $http
            .delete(ApiEndpoint.url+'/membros/remove/'+id, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
    ...
    var removeAll = function(dados) {
        ...
        var deferred = $q.defer();
        $http
            .post(ApiEndpoint.url+'/membros/removeAll', data, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
