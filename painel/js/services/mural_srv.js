angular.module('SmartChurchPanel').factory('Mural', function ($localstorage, $q, $http, ApiEndpoint) {
    ...
    var create = function(dados) {
        ...
        $http
            .post(ApiEndpoint.url+'/mural/create', data, {
                headers: {
    ...
    var createForIgreja = function(dados) {
        ...
        var deferred = $q.defer();
        $http
            .post(ApiEndpoint.url+'/mural/createForIgreja', data, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
    ...
    var edit = function(id, dados) {
        ...
        var deferred = $q.defer();
        $http
            .put(ApiEndpoint.url+'/mural/edit/'+id, data, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
    ...
    var changeStat = function(id, dados) {
        ...
        var deferred = $q.defer();
        $http
            .put(ApiEndpoint.url+'/mural/changestat/'+id, data, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
    ...
    var getMe = function(id) {
        ...
        $http
            .get(ApiEndpoint.url+'/mural/me?id='+id, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
    ...
    var getAll = function(page, pagesize, searchBy, orderBy, groupBy, stat, igreja, video, destinatarios) {
        ...
        $http
            .get(ApiEndpoint.url+'/mural/all?page='+pg+'&pageSize='+ps+'&searchBy='+sb+
                        '&orderBy='+ob+'&groupBy='+gb+'&stat='+st+'&igreja='+ig+
                        '&video='+vd+'&destinatarios='+dt, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
    ...
    var remove = function(id) {
        ...
        $http
            .delete(ApiEndpoint.url+'/mural/remove/'+id, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
    ...
    var removeAll = function(dados) {
        ...
        var deferred = $q.defer();
        $http
            .post(ApiEndpoint.url+'/mural/removeAll', data, {
                headers: {
                    "Authorization": "token=" + token
                }
            })
