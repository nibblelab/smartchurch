angular.module('SmartChurchPanel').controller('IgrejadaFederacaoCtrl', function ($scope, $state, $stateParams, $localstorage, $notifications, $rootScope, $dialogs, $timeout, 
                    $context,
                    Data, Sociedade, Igreja) { 
    ...
    /* search */
    $scope.storage_cache_name = 'search_igrejasdafederacao';
    $scope.searchBy = '';
    $scope.page = 1;
    $scope.pageSize = '10';
    $scope.hasPrev = false;
    ...
    $scope.doSearch = function(is_new) {
        ...
        $scope.list = [];
        Igreja.getAll($scope.page, $scope.pageSize, $scope.searchBy, $scope.orderBy, '', $scope.stat, 
