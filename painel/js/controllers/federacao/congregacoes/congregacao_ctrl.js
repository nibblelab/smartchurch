angular.module('SmartChurchPanel').controller('CongregacaodaFederacaoCtrl', function ($scope, $state, $stateParams, $localstorage, $notifications, $rootScope, $dialogs, $timeout, 
                    $context,
                    Data, Sociedade, Igreja, Congregacao) { 
    ...
    /* search */
    $scope.storage_cache_name = 'search_congregacoesdafederacao';
    $scope.searchBy = '';
    $scope.page = 1;
    $scope.pageSize = '10';
    $scope.hasPrev = false;
