angular.module('SmartChurchPanel').controller('IgrejadaSinodalCtrl', function ($scope, $state, $stateParams, $localstorage, $notifications, $rootScope, $dialogs, $timeout, 
                    $context, $cache,
                    Sociedade, Federacao, Igreja) { 
    ...
    /* search */
    $scope.storage_cache_name = 'search_igrejasdasinodal';
    $scope.searchBy = '';
    $scope.page = 1;
    $scope.pageSize = '10';
    $scope.hasPrev = false;
