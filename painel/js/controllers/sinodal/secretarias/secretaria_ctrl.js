angular.module('SmartChurchPanel').controller('SecretariaDaSinodalCtrl', function ($scope, $state, $stateParams, $localstorage, $notifications, 
    ...
    $scope.sref = {
        back: ($stateParams.back == '') ? 'SmartChurchPanel.sinodal.secretarias.buscar' : $stateParams.back,
        backParams: { },
        add: "SmartChurchPanel.sinodal.secretarias.adicionar",
        addParams: { back: 'SmartChurchPanel.sinodal.secretarias.buscar' },
        edit: "SmartChurchPanel.sinodal.secretarias.editar",
        editParams: { id: '', title: 'Editando', back: 'SmartChurchPanel.sinodal.secretarias.buscar' },
        substate: 'SmartChurchPanel.sinodal.secretarias.secretarios.buscar',
    ...
    $scope.localPerms = {
        add: 'SecretariaSinodalSave',
        edit: 'SecretariaSinodalSave',
        changeStat: 'SecretariaSinodalBlock',
        secretario: 'SecretariaSinodalPessoa',
        remove: 'SecretariaSinodalRemove'
    };
    ...
    /* search */
    $scope.storage_cache_name = 'search_secretariasdasinodal';
    $scope.searchBy = '';
    $scope.page = 1;
    $scope.pageSize = '10';
    $scope.hasPrev = false;
    ...
    $scope.doSave = function() {
        ...
        if ($scope.dataFrm.isValid) {
            ...
            if($scope.isCreate)
            {
                promise = Secretaria.createForSinodal($scope.dataFrm.toSend);
            }
            else
            {
