angular.module('SmartChurchPanel').controller('PontodaSinodalCtrl', function ($scope, $state, $stateParams, $localstorage, $notifications, $rootScope, $dialogs, $timeout, 
                    $context, $cache,
                    Sociedade, Igreja, Federacao, PontoDePregacao) { 
    ...
    /* search */
    $scope.storage_cache_name = 'search_pontosdasinodal';
    $scope.searchBy = '';
    $scope.page = 1;
    $scope.pageSize = '10';
    $scope.hasPrev = false;
