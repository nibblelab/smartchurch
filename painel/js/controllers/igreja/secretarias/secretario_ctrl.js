angular.module('SmartChurchPanel').controller('SecretarioDaIgrejaCtrl', function ($scope, $state, $stateParams, $localstorage, $notifications, 
                    $rootScope, $dialogs, $timeout, $context, $cache,
                    Data, Secretaria, MembroDaIgreja, Perfil, SysConfig, Secretario) { 
    ...
    $scope.sref = {
        back_level2: 'SmartChurchPanel.igreja.secretarias.buscar()',
        back: ($stateParams.back == '') ? 'SmartChurchPanel.igreja.secretarias.secretarios.buscar' : $stateParams.back,
        backParams: { secretaria: $scope.secretaria },
        add: "SmartChurchPanel.igreja.secretarias.secretarios.adicionar",
        addParams: { back: 'SmartChurchPanel.igreja.secretarias.secretarios.buscar', secretaria: $scope.secretaria },
        edit: "SmartChurchPanel.igreja.secretarias.secretarios.editar",
        editParams: { id: '', title: 'Editando', back: 'SmartChurchPanel.igreja.secretarias.secretarios.buscar', secretaria: $scope.secretaria }
    };
    ...
    $scope.localPerms = {
        add: 'SecretariaIgrejaPessoa',
        edit: 'SecretariaIgrejaPessoa',
        changeStat: 'SecretariaIgrejaPessoa',
        remove: 'SecretariaIgrejaPessoa'
    };
    ...
    }, function(e) { console.log(e); $state.go('SmartChurchPanel.igreja.secretariasbuscar()'); });
    
    /* search */
    $scope.storage_cache_name = 'search_secretariosdaigreja';
    $scope.searchBy = '';
    $scope.page = 1;
    $scope.pageSize = '10';
    $scope.hasPrev = false;
