angular.module('SmartChurchPanel').controller('SecretariaDaIgrejaCtrl', function ($scope, $state, $stateParams, $localstorage, $notifications, 
    ...
    $scope.sref = {
        back: ($stateParams.back == '') ? 'SmartChurchPanel.igreja.secretarias.buscar' : $stateParams.back,
        backParams: { },
        add: "SmartChurchPanel.igreja.secretarias.adicionar",
        addParams: { back: 'SmartChurchPanel.igreja.secretarias.buscar' },
        edit: "SmartChurchPanel.igreja.secretarias.editar",
        editParams: { id: '', title: 'Editando', back: 'SmartChurchPanel.igreja.secretarias.buscar' },
        substate: 'SmartChurchPanel.igreja.secretarias.secretarios.buscar',
    ...
    $scope.localPerms = {
        add: 'SecretariaIgrejaSave',
        edit: 'SecretariaIgrejaSave',
        changeStat: 'SecretariaIgrejaBlock',
        secretario: 'SecretariaIgrejaPessoa',
        remove: 'SecretariaIgrejaRemove'
    };
    ...
    /* search */
    $scope.storage_cache_name = 'search_secretariasdaigreja';
    $scope.searchBy = '';
    $scope.page = 1;
    $scope.pageSize = '10';
    $scope.hasPrev = false;
    ...
    $scope.doSave = function() {
        ...
        if ($scope.dataFrm.isValid) {
            ...
            if($scope.isCreate)
            {
                promise = Secretaria.createForIgreja($scope.dataFrm.toSend);
            }
            else
            {
