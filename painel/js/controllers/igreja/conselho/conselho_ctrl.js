angular.module('SmartChurchPanel').controller('ConselhoDaIgrejaCtrl', function ($scope, $state, $stateParams, $localstorage, $notifications, 
                    $rootScope, $context, Conselho) { 
    ...
    $scope.back = ($stateParams.back == '') ? 'SmartChurchPanel.igreja.conselho.buscar()' : $stateParams.back + '()';
    $scope.id = $stateParams.id;
    $scope.objList = 'Conselho da Igreja';
    ...
    /* search */
    $scope.storage_cache_name = 'search_conselhodaigreja';
    $scope.searchBy = '';
    $scope.page = 1;
    $scope.pageSize = '10';
    $scope.hasPrev = false;
    ...
    $scope.doSearch = function(is_new) {
        ...
        $scope.list = [];
        Conselho.getAll($scope.page, $scope.pageSize, $scope.searchBy, $scope.orderBy, '', $scope.igreja).then(function(r) {
            if (r.datas.length > 0) {
