angular.module('SmartChurchPanel').controller('SecretariaDaSociedadeCtrl', function ($scope, $state, $stateParams, $localstorage, $notifications, 
    ...
    $scope.sref = {
        back: ($stateParams.back == '') ? 'SmartChurchPanel.sociedade.secretarias.buscar' : $stateParams.back,
        backParams: { },
        add: "SmartChurchPanel.sociedade.secretarias.adicionar",
        addParams: { back: 'SmartChurchPanel.sociedade.secretarias.buscar' },
        edit: "SmartChurchPanel.sociedade.secretarias.editar",
        editParams: { id: '', title: 'Editando', back: 'SmartChurchPanel.sociedade.secretarias.buscar' },
        substate: 'SmartChurchPanel.sociedade.secretarias.secretarios.buscar',
    ...
    $scope.localPerms = {
        add: 'SecretariaSociedadeSave',
        edit: 'SecretariaSociedadeSave',
        changeStat: 'SecretariaSociedadeBlock',
        secretario: 'SecretariaSociedadePessoa',
        remove: 'SecretariaSociedadeRemove'
    };
    ...
    /* search */
    $scope.storage_cache_name = 'search_secretariasdasociedade';
    $scope.searchBy = '';
    $scope.page = 1;
    $scope.pageSize = '10';
    $scope.hasPrev = false;
    ...
    $scope.doSave = function() {
        ...
        if ($scope.dataFrm.isValid) {
            ...
            if($scope.isCreate)
            {
                promise = Secretaria.createForSociedade($scope.dataFrm.toSend);
            }
            else
            {
