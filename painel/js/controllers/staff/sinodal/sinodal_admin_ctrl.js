angular.module('SmartChurchPanel').controller('SinodalAdminCtrl', function ($scope, $state, $stateParams, $localstorage, $notifications, $rootScope, $dialogs, $timeout,
                    $modulos, $generator,
                    Perfil, SysConfig, Sinodal, Admin) { 
        ...
        Perfil.getAllNoStaff().then(function(r) {
            ...
            SysConfig.getAll().then(function(r) {
                if(r.total > 0) {
                    ...
                    $scope.dataFrm.data.perfil.value = $scope.listConfigs[0].perfil_sinodal;
                }
    ...
    $scope.doSave = function() {
        ...
        if ($scope.dataFrm.isValid) {
            ...
            if($scope.isCreate)
            {
                promise = Admin.createForSinodal($scope.dataFrm.toSend);
            }
            else
            {
