...
public interface OficialService {
    @GET("oficiais/all")
    Call<ResponseData<List<OficialData>>> getAll(@Query("page") String page, @Query("pageSize") String pagesize,
                                               ...
                                               @Query("stat") String stat, @Query("cargo") String cargo,
                                               @Query("diretoria") String diretoria, @Query("pessoa") String pessoa,
                                               @Query("igreja") String igreja, @Query("sociedade") String sociedade,
