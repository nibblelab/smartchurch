...
public class PresbiterioData {
    ...
    public PresbiterioData() {
    }

    public PresbiterioData(String id, String sinodo, String sigla, String nome, String fundacao, String localidades,
    ...
    public static String getIdByNomeOnList(List<PresbiterioData> list, String nome)
    {
        for(PresbiterioData d: list)
        {
