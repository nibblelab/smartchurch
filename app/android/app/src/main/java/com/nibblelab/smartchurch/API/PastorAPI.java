...
import com.nibblelab.smartchurch.API.requests.PastorRequests;
...
public class PastorAPI extends BaseAPI {
    public final String TAG = "PastorAPI";

    public PastorAPI(final Base b) {
        super(b);
    }

    public void getPastores(String page, String pagesize, String searchBy, String orderBy, String igreja, String stat,
    ...
    {
        Call<ResponseData<List<OficialData>>> call = new PastorRequests().getService().getAll(page, pagesize, searchBy, orderBy, igreja, stat,
        ...
        call.enqueue(new Callback<ResponseData<List<OficialData>>>() {
            ...
            public void onFailure(Call<ResponseData<List<OficialData>>> call, Throwable t) {
                try {
                    ...
                    Log.e(TAG, "[getPastores] Erro: " + t.getMessage());
    ...
    public void getAllPastores(final ApiResponse r)
    {
        getPastores("", "", "", "", "", "",
                "", "", "", "", "", false,
                false, r);
    ...
    public void getAllPastoresForIgreja(String igreja, final ApiResponse r)
    {
        getPastores("", "", "", "", igreja, "",
                "", "", "", "", "", false,
                false, r);
