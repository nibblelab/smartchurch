<?php
require_once ADO_PATH . '/Candidatos.class.php'; 
require_once DAO_PATH . '/CandidatosDAO.class.php'; 

/**
 * API REST de Candidatos
 */
class CandidatosWS extends WSUtil
{
    /**
     * 
     * Cria
    ...
    public function create(): array
    {
        ...
        $dto = new CandidatosDTO();
        $obj = new CandidatosADO();
    ...
    public function all(): array
    {
        ...
        {   
            ...
            CandidatosADO::addComparison($dto, '', CMP_INCLUDE_INSIDE, $searchBy);
            CandidatosADO::addComparison($dto, '', CMP_INCLUDE_INSIDE, $searchBy, OP_OR);
        }
        ...
        if(!empty($orderBy))
        {
            ...
            CandidatosADO::addOrdering($dto, $order_by_v[0], ($order_by_v[1] == 'asc') ? ORDER_ASC : ORDER_DESC);
        }
        ...
        if(!empty($groupBy))
        {
            ...
            foreach($groups as $g) {
                CandidatosADO::addGrouping($dto, $g);
            }
        }
