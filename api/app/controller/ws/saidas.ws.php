<?php
require_once ADO_PATH . '/Saidas.class.php'; 
require_once DAO_PATH . '/SaidasDAO.class.php'; 

/**
 * API REST de Saidas
 */
class SaidasWS extends WSUtil
{
    /**
     * 
     * Cria
    ...
    public function all(): array
    {
        ...
        {   
            ...
            SaidasADO::addComparison($dto, '', CMP_INCLUDE_INSIDE, $searchBy);
            SaidasADO::addComparison($dto, '', CMP_INCLUDE_INSIDE, $searchBy, OP_OR);
        }
        ...
        if(!empty($orderBy))
        {
            ...
            SaidasADO::addOrdering($dto, $order_by_v[0], ($order_by_v[1] == 'asc') ? ORDER_ASC : ORDER_DESC);
        }
