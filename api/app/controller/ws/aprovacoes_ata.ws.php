<?php
require_once ADO_PATH . '/AprovacoesAta.class.php'; 
require_once DAO_PATH . '/AprovacoesAtaDAO.class.php'; 

/**
 * API REST de AprovacoesAta
 */
class AprovacoesAtaWS extends WSUtil
{
    /**
     * 
     * Cria
    ...
    public function create(): array
    {
        ...
        $dto = new AprovacoesAtaDTO();
        $obj = new AprovacoesAtaADO();
        
        $dto->add = true;
        $dto->id = NblFram::$context->data->id;
        $dto->ata = NblFram::$context->data->ata;
        $dto->pessoa = NblFram::$context->data->pessoa;
        $dto->aprovado = NblFram::$context->data->aprovado;
    ...
    public function all(): array
    {
        ...
        $dto = new AprovacoesAtaDTO();
        $obj = new AprovacoesAtaADO();
        $obj_count = new AprovacoesAtaADO();
        ...
        {   
            ...
            AprovacoesAtaADO::addComparison($dto, '', CMP_INCLUDE_INSIDE, $searchBy);
            AprovacoesAtaADO::addComparison($dto, '', CMP_INCLUDE_INSIDE, $searchBy, OP_OR);
        }
        ...
        if(!empty($orderBy))
        {
            ...
            AprovacoesAtaADO::addOrdering($dto, $order_by_v[0], ($order_by_v[1] == 'asc') ? ORDER_ASC : ORDER_DESC);
        }
        ...
        if(!empty($groupBy))
        {
            ...
            foreach($groups as $g) {
                AprovacoesAtaADO::addGrouping($dto, $g);
            }
        }
