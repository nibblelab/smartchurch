<?php
require_once ADO_PATH . '/Entradas.class.php'; 
require_once DAO_PATH . '/EntradasDAO.class.php'; 

/**
 * API REST de Entradas
 */
class EntradasWS extends WSUtil
{
    /**
     * 
    ...
    public function create(): array
    {
        ...
        $dto->registro = NblFram::$context->data->registro;
        $dto->valor = NblFram::$context->data->valor;
        $dto->data_registro = NblFram::$context->data->data_registro;
    ...
    public function all(): array
    {
        ...
        {   
            ...
            EntradasADO::addComparison($dto, '', CMP_INCLUDE_INSIDE, $searchBy);
            EntradasADO::addComparison($dto, '', CMP_INCLUDE_INSIDE, $searchBy, OP_OR);
        }
        ...
        if(!empty($orderBy))
        {
            ...
            EntradasADO::addOrdering($dto, $order_by_v[0], ($order_by_v[1] == 'asc') ? ORDER_ASC : ORDER_DESC);
        }
