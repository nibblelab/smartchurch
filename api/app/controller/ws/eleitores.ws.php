<?php
require_once ADO_PATH . '/Eleitores.class.php'; 
require_once DAO_PATH . '/EleitoresDAO.class.php'; 

/**
 * API REST de Eleitores
 */
class EleitoresWS extends WSUtil
{
    /**
     * 
     * Cria
    ...
    public function create(): array
    {
        ...
        $dto = new EleitoresDTO();
        $obj = new EleitoresADO();
    ...
    public function all(): array
    {
        ...
        {   
            ...
            EleitoresADO::addComparison($dto, '', CMP_INCLUDE_INSIDE, $searchBy);
            EleitoresADO::addComparison($dto, '', CMP_INCLUDE_INSIDE, $searchBy, OP_OR);
        }
        ...
        if(!empty($orderBy))
        {
            ...
            EleitoresADO::addOrdering($dto, $order_by_v[0], ($order_by_v[1] == 'asc') ? ORDER_ASC : ORDER_DESC);
        }
        ...
        if(!empty($groupBy))
        {
            ...
            foreach($groups as $g) {
                EleitoresADO::addGrouping($dto, $g);
            }
        }
