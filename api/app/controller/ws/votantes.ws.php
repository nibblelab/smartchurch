<?php
require_once ADO_PATH . '/Votantes.class.php'; 
require_once DAO_PATH . '/VotantesDAO.class.php'; 

/**
 * API REST de Votantes
 */
class VotantesWS extends WSUtil
{
    /**
     * 
     * @var \VotantesWS singleton instance
     */
     ...
     * @return \VotantesWS
     */
    public static function getInstance(): \VotantesWS {
    ...
    public function all(): array
    {
        ...
        {   
            ...
            VotantesADO::addComparison($dto, '', CMP_INCLUDE_INSIDE, $searchBy);
            VotantesADO::addComparison($dto, '', CMP_INCLUDE_INSIDE, $searchBy, OP_OR);
        }
        ...
        if(!empty($orderBy))
        {
            ...
            VotantesADO::addOrdering($dto, $order_by_v[0], ($order_by_v[1] == 'asc') ? ORDER_ASC : ORDER_DESC);
        }
