<?php
require_once ADO_PATH . '/Checkins.class.php'; 
require_once DAO_PATH . '/CheckinsDAO.class.php'; 

/**
 * API REST de Checkins
 */
class CheckinsWS extends WSUtil
{
    /**
     * 
    ...
    public function all(): array
    {
        ...
        {   
            ...
            CheckinsADO::addComparison($dto, '', CMP_INCLUDE_INSIDE, $searchBy);
            CheckinsADO::addComparison($dto, '', CMP_INCLUDE_INSIDE, $searchBy, OP_OR);
        }
        ...
        if(!empty($orderBy))
        {
            ...
            CheckinsADO::addOrdering($dto, $order_by_v[0], ($order_by_v[1] == 'asc') ? ORDER_ASC : ORDER_DESC);
        }
