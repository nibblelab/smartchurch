...
/**
 * API REST de PontosDePregacao
 */
class PontosDePregacaoWS extends WSUtil
{
    /**
     * 
     * @var \PontosDePregacaoWS singleton instance
     */
     ...
     * 
     * @return \PontosDePregacaoWS
     */
    public static function getInstance(): \PontosDePregacaoWS {
    ...
    {
        if(!doIHavePermission(NblFram::$context->token, 'PontoSave,PontoIgrejaSave')) {
        ...
        $dto->organizada = IgrejaOrganizacao::PONTO;
    ...
    {
        if(!doIHavePermission(NblFram::$context->token, 'PontoBlock,PontoIgrejaBlock')) {
            return array('status' => 'no', 'success' => false, 'msg' => 'Você não tem permissão para executar essa operação');
        }
    ...
    {
        if(!doIHavePermission(NblFram::$context->token, 'Ponto,PontoIgreja')) {
            return array('status' => 'no', 'success' => false, 'msg' => 'Você não tem permissão para executar essa operação');
        }
    ...
    {
        if(!doIHavePermission(NblFram::$context->token, 'Ponto,PontoIgreja,PontoFederacao,PontoSinodal')) {
            return array('status' => 'no', 'success' => false, 'msg' => 'Você não tem permissão para executar essa operação');
        }
        ...
        IgrejasADO::addComparison($dto, 'organizada', CMP_EQUAL, IgrejaOrganizacao::PONTO);
    ...
    {
        if(!doIHavePermission(NblFram::$context->token, 'PontoRemove,PontoIgrejaRemove')) {
            return array('status' => 'no', 'success' => false, 'msg' => 'Você não tem permissão para executar essa operação');
        }
