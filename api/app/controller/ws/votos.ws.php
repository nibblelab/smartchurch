<?php
require_once ADO_PATH . '/Votos.class.php'; 
require_once DAO_PATH . '/VotosDAO.class.php'; 

/**
 * API REST de Votos
 */
class VotosWS extends WSUtil
{
    /**
     * 
    ...
    public function create(): array
    {
        ...
        $dto->candidato = NblFram::$context->data->candidato;
    ...
    public function all(): array
    {
        ...
        {   
            ...
            VotosADO::addComparison($dto, '', CMP_INCLUDE_INSIDE, $searchBy);
            VotosADO::addComparison($dto, '', CMP_INCLUDE_INSIDE, $searchBy, OP_OR);
        }
        ...
        if(!empty($orderBy))
        {
            ...
            VotosADO::addOrdering($dto, $order_by_v[0], ($order_by_v[1] == 'asc') ? ORDER_ASC : ORDER_DESC);
        }
