<?php
require_once ADO_PATH . '/Atas.class.php'; 
require_once DAO_PATH . '/AtasDAO.class.php'; 

/**
 * API REST de Atas
 */
class AtasWS extends WSUtil
{
    /**
     * 
    ...
    public function create(): array
    {
        ...
        $dto->arquivo = NblFram::$context->data->arquivo;
    ...
    public function all(): array
    {
        ...
        {   
            ...
            AtasADO::addComparison($dto, '', CMP_INCLUDE_INSIDE, $searchBy);
            AtasADO::addComparison($dto, '', CMP_INCLUDE_INSIDE, $searchBy, OP_OR);
        }
        ...
        if(!empty($orderBy))
        {
            ...
            AtasADO::addOrdering($dto, $order_by_v[0], ($order_by_v[1] == 'asc') ? ORDER_ASC : ORDER_DESC);
        }
