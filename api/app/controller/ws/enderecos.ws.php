<?php
require_once ADO_PATH . '/Enderecos.class.php'; 
require_once DAO_PATH . '/EnderecosDAO.class.php'; 

/**
 * API REST de Enderecos
 */
class EnderecosWS extends WSUtil
{
    /**
     * 
     * @var \EnderecosWS singleton instance
     */
     ...
     * @return \EnderecosWS
     */
    public static function getInstance(): \EnderecosWS {
    ...
    public function create(): array
    {
        ...
        $dto = new EnderecosDTO();
        $obj = new EnderecosADO();
    ...
    public function all(): array
    {
        ...
        {   
            ...
            EnderecosADO::addComparison($dto, '', CMP_INCLUDE_INSIDE, $searchBy);
            EnderecosADO::addComparison($dto, '', CMP_INCLUDE_INSIDE, $searchBy, OP_OR);
        }
        ...
        if(!empty($orderBy))
        {
            ...
            EnderecosADO::addOrdering($dto, $order_by_v[0], ($order_by_v[1] == 'asc') ? ORDER_ASC : ORDER_DESC);
        }
        ...
        if(!empty($groupBy))
        {
            ...
            foreach($groups as $g) {
                EnderecosADO::addGrouping($dto, $g);
            }
        }
