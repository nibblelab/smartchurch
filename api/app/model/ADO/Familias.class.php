...
/**
 * Classe de dados (DTO) do Familias
 *
 *
 */
class FamiliasDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o Familias
 *
 *
 */
class FamiliasADO extends BaseADO
{ 
    /**
