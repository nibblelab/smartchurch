...
/**
 * Classe de dados (DTO) do Oficiais
 *
 *
 */
class OficiaisDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o Oficiais
 *
 *
 */
class OficiaisADO extends BaseADO
{ 
    /**
