...
/**
 * Classe de dados (DTO) do Enderecos
 *
 *
 */
class EnderecosDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o Enderecos
 *
 *
 */
class EnderecosADO extends BaseADO
{ 
    /**
