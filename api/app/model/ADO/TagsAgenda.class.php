...
/**
 * Classe de dados (DTO) do TagsAgenda
 *
 *
 */
class TagsAgendaDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o TagsAgenda
 *
 *
 */
class TagsAgendaADO extends BaseADO
{ 
    /**
