...
/**
 * Classe de dados (DTO) do ConfigsPagto
 *
 *
 */
class ConfigsPagtoDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o ConfigsPagto
 *
 *
 */
class ConfigsPagtoADO extends BaseADO
{ 
    /**
