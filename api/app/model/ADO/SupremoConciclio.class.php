...
/**
 * Classe de dados (DTO) do SupremoConciclio
 *
 *
 */
class SupremoConciclioDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o SupremoConciclio
 *
 *
 */
class SupremoConciclioADO extends BaseADO
{ 
    /**
    ...
    {
        $this->dao = new SupremoConciclioDAO();
        $this->size = 0;
        $this->errs = array();
    }
