...
/**
 * Classe de dados (DTO) do PequenosGrupos
 *
 *
 */
class PequenosGruposDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o PequenosGrupos
 *
 *
 */
class PequenosGruposADO extends BaseADO
{ 
    /**
    ...
    {
        $this->dao = new PequenosGruposDAO();
        $this->size = 0;
        $this->errs = array();
    }
