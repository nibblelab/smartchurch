...
/**
 * Classe de dados (DTO) do Diretorias
 *
 *
 */
class DiretoriasDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o Diretorias
 *
 *
 */
class DiretoriasADO extends BaseADO
{ 
    /**
