...
/**
 * Classe de dados (DTO) do Comissoes
 *
 *
 */
class ComissoesDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o Comissoes
 *
 *
 */
class ComissoesADO extends BaseADO
{ 
    /**
