...
/**
 * Classe de dados (DTO) do Permissoes
 *
 *
 */
class PermissoesDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o Permissoes
 *
 *
 */
class PermissoesADO extends BaseADO
{ 
    /**
