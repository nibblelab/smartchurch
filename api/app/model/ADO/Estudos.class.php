...
/**
 * Classe de dados (DTO) do Estudos
 *
 *
 */
class EstudosDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o Estudos
 *
 *
 */
class EstudosADO extends BaseADO
{ 
    /**
