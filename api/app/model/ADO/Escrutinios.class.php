...
/**
 * Classe de dados (DTO) do Escrutinios
 *
 *
 */
class EscrutiniosDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o Escrutinios
 *
 *
 */
class EscrutiniosADO extends BaseADO
{ 
    /**
