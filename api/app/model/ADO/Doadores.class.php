...
/**
 * Classe de dados (DTO) do Doadores
 *
 *
 */
class DoadoresDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o Doadores
 *
 *
 */
class DoadoresADO extends BaseADO
{ 
    /**
