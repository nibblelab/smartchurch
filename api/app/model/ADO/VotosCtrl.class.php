...
/**
 * Classe de dados (DTO) do VotosCtrl
 *
 *
 */
class VotosCtrlDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o VotosCtrl
 *
 *
 */
class VotosCtrlADO extends BaseADO
{ 
    /**
