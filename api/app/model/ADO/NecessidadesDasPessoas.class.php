...
/**
 * Classe de dados (DTO) do NecessidadesDasPessoas
 *
 *
 */
class NecessidadesDasPessoasDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o NecessidadesDasPessoas
 *
 *
 */
class NecessidadesDasPessoasADO extends BaseADO
{ 
    /**
    ...
    {
        $this->dao = new NecessidadesDasPessoasDAO();
        $this->size = 0;
        $this->errs = array();
    }
