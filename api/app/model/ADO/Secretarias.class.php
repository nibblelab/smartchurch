...
/**
 * Classe de dados (DTO) do Secretarias
 *
 *
 */
class SecretariasDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o Secretarias
 *
 *
 */
class SecretariasADO extends BaseADO
{ 
    /**
