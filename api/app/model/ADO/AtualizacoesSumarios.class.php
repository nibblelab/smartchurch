...
/**
 * Classe de dados (DTO) do AtualizacoesSumarios
 *
 *
 */
class AtualizacoesSumariosDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o AtualizacoesSumarios
 *
 *
 */
class AtualizacoesSumariosADO extends BaseADO
{ 
    /**
    ...
    {
        $this->dao = new AtualizacoesSumariosDAO();
        $this->size = 0;
        $this->errs = array();
    }
