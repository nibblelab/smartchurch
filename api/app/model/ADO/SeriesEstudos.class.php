...
/**
 * Classe de dados (DTO) do SeriesEstudos
 *
 *
 */
class SeriesEstudosDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o SeriesEstudos
 *
 *
 */
class SeriesEstudosADO extends BaseADO
{ 
    /**
