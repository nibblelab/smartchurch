...
/**
 * Classe de dados (DTO) do Transmissoes
 *
 *
 */
class TransmissoesDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o Transmissoes
 *
 *
 */
class TransmissoesADO extends BaseADO
{ 
    /**
