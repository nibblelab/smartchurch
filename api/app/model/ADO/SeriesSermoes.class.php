...
/**
 * Classe de dados (DTO) do SeriesSermoes
 *
 *
 */
class SeriesSermoesDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o SeriesSermoes
 *
 *
 */
class SeriesSermoesADO extends BaseADO
{ 
    /**
