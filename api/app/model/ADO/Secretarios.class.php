...
/**
 * Classe de dados (DTO) do Secretarios
 *
 *
 */
class SecretariosDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o Secretarios
 *
 *
 */
class SecretariosADO extends BaseADO
{ 
    /**
