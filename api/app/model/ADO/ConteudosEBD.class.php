...
/**
 * Classe de dados (DTO) do ConteudosEBD
 *
 *
 */
class ConteudosEBDDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o ConteudosEBD
 *
 *
 */
class ConteudosEBDADO extends BaseADO
{ 
    /**
