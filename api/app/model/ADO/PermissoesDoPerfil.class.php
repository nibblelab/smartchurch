...
/**
 * Classe de dados (DTO) do PermissoesDoPerfil
 *
 *
 */
class PermissoesDoPerfilDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o PermissoesDoPerfil
 *
 *
 */
class PermissoesDoPerfilADO extends BaseADO
{ 
    /**
    ...
    {
        $this->dao = new PermissoesDoPerfilDAO();
        $this->size = 0;
        $this->errs = array();
    }
