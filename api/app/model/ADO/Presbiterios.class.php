...
/**
 * Classe de dados (DTO) do Presbiterios
 *
 *
 */
class PresbiteriosDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o Presbiterios
 *
 *
 */
class PresbiteriosADO extends BaseADO
{ 
    /**
