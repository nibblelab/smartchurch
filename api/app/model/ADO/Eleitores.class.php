...
/**
 * Classe de dados (DTO) do Eleitores
 *
 *
 */
class EleitoresDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o Eleitores
 *
 *
 */
class EleitoresADO extends BaseADO
{ 
    /**
