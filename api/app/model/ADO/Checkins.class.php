...
/**
 * Classe de dados (DTO) do Checkins
 *
 *
 */
class CheckinsDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o Checkins
 *
 *
 */
class CheckinsADO extends BaseADO
{ 
    /**
