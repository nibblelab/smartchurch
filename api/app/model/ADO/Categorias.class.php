...
/**
 * Classe de dados (DTO) do Categorias
 *
 *
 */
class CategoriasDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o Categorias
 *
 *
 */
class CategoriasADO extends BaseADO
{ 
    /**
