...
/**
 * Classe de dados (DTO) do Doacoes
 *
 *
 */
class DoacoesDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o Doacoes
 *
 *
 */
class DoacoesADO extends BaseADO
{ 
    /**
