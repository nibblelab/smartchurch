...
/**
 * Classe de dados (DTO) do AlunosDasSalas
 *
 *
 */
class AlunosDasSalasDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o AlunosDasSalas
 *
 *
 */
class AlunosDasSalasADO extends BaseADO
{ 
    /**
    ...
    {
        $this->dao = new AlunosDasSalasDAO();
        $this->size = 0;
        $this->errs = array();
    }
