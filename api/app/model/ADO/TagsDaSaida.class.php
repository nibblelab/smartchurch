...
/**
 * Classe de dados (DTO) do TagsDaSaida
 *
 *
 */
class TagsDaSaidaDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o TagsDaSaida
 *
 *
 */
class TagsDaSaidaADO extends BaseADO
{ 
    /**
