...
/**
 * Classe de dados (DTO) do Entradas
 *
 *
 */
class EntradasDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o Entradas
 *
 *
 */
class EntradasADO extends BaseADO
{ 
    /**
