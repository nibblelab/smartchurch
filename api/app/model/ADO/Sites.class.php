...
/**
 * Classe de dados (DTO) do Sites
 *
 *
 */
class SitesDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o Sites
 *
 *
 */
class SitesADO extends BaseADO
{ 
    /**
