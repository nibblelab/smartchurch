...
/**
 * Classe de dados (DTO) do Profissoes
 *
 *
 */
class ProfissoesDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o Profissoes
 *
 *
 */
class ProfissoesADO extends BaseADO
{ 
    /**
