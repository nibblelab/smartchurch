...
/**
 * Classe de dados (DTO) do NecessidadesEspeciais
 *
 *
 */
class NecessidadesEspeciaisDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o NecessidadesEspeciais
 *
 *
 */
class NecessidadesEspeciaisADO extends BaseADO
{ 
    /**
    ...
    {
        $this->dao = new NecessidadesEspeciaisDAO();
        $this->size = 0;
        $this->errs = array();
    }
