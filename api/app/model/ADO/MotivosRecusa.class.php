...
/**
 * Classe de dados (DTO) do MotivosRecusa
 *
 *
 */
class MotivosRecusaDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o MotivosRecusa
 *
 *
 */
class MotivosRecusaADO extends BaseADO
{ 
    /**
