...
/**
 * Classe de dados (DTO) do Servos
 *
 *
 */
class ServosDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o Servos
 *
 *
 */
class ServosADO extends BaseADO
{ 
    /**
