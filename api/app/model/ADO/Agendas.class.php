...
/**
 * Classe de dados (DTO) do Agendas
 *
 *
 */
class AgendasDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o Agendas
 *
 *
 */
class AgendasADO extends BaseADO
{ 
    /**
