...
/**
 * Classe de dados (DTO) do ProfessoresDasSalas
 *
 *
 */
class ProfessoresDasSalasDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o ProfessoresDasSalas
 *
 *
 */
class ProfessoresDasSalasADO extends BaseADO
{ 
    /**
    ...
    {
        $this->dao = new ProfessoresDasSalasDAO();
        $this->size = 0;
        $this->errs = array();
    }
