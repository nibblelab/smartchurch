...
/**
 * Classe de dados (DTO) do HistoricoMembresia
 *
 *
 */
class HistoricoMembresiaDTO extends BaseDTO
{
    ...
    public $igreja;
    public $pastor;
    public $telefone_pastor;
    public $email_pastor;
    public $membro;
    public $frequentou_de;
    public $frequentou_ate;
    public $comungante;
    public $batizado;
    public $data_batismo;
    public $time_cad;
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o HistoricoMembresia
 *
 *
 */
class HistoricoMembresiaADO extends BaseADO
{ 
    /**
    ...
    {
        $this->dao = new HistoricoMembresiaDAO();
        $this->size = 0;
        $this->errs = array();
    }
