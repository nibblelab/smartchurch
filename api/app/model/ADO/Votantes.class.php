...
/**
 * Classe de dados (DTO) do Votantes
 *
 *
 */
class VotantesDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o Votantes
 *
 *
 */
class VotantesADO extends BaseADO
{ 
    /**
