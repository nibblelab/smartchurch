...
/**
 * Classe de dados (DTO) do Participantes
 *
 *
 */
class ParticipantesDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o Participantes
 *
 *
 */
class ParticipantesADO extends BaseADO
{ 
    /**
