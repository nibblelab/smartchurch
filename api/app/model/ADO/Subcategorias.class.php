...
/**
 * Classe de dados (DTO) do Subcategorias
 *
 *
 */
class SubcategoriasDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o Subcategorias
 *
 *
 */
class SubcategoriasADO extends BaseADO
{ 
    /**
