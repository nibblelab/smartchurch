...
/**
 * Classe de dados (DTO) do FreqSumarios
 *
 *
 */
class FreqSumariosDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o FreqSumarios
 *
 *
 */
class FreqSumariosADO extends BaseADO
{ 
    /**
