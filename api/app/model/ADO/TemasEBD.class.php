...
/**
 * Classe de dados (DTO) do TemasEBD
 *
 *
 */
class TemasEBDDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o TemasEBD
 *
 *
 */
class TemasEBDADO extends BaseADO
{ 
    /**
