...
/**
 * Classe de dados (DTO) do PessoasDasCes
 *
 *
 */
class PessoasDasCesDTO extends BaseDTO
{
    /* dados propriamento ditos */
    public $pessoa;
    public $comissao_executiva;
}

/**
 * Classe Façade que provê interface entre o DAO e o controller para o PessoasDasCes
 *
 *
 */
class PessoasDasCesADO extends BaseADO
{ 
    /**
