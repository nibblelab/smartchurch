...
/**
 * Classe de dados (DTO) do Cidades
 *
 *
 */
class CidadesDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o Cidades
 *
 *
 */
class CidadesADO extends BaseADO
{ 
    /**
