...
/**
 * Classe de dados (DTO) do PedidosOracao
 *
 *
 */
class PedidosOracaoDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o PedidosOracao
 *
 *
 */
class PedidosOracaoADO extends BaseADO
{ 
    /**
