...
/**
 * Classe de dados (DTO) do Bookmarks
 *
 *
 */
class BookmarksDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o Bookmarks
 *
 *
 */
class BookmarksADO extends BaseADO
{ 
    /**
