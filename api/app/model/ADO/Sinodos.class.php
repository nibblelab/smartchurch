...
/**
 * Classe de dados (DTO) do Sinodos
 *
 *
 */
class SinodosDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o Sinodos
 *
 *
 */
class SinodosADO extends BaseADO
{ 
    /**
