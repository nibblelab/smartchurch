...
/**
 * Classe de dados (DTO) do Sinodais
 *
 *
 */
class SinodaisDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o Sinodais
 *
 *
 */
class SinodaisADO extends BaseADO
{ 
    /**
