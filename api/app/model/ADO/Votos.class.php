...
/**
 * Classe de dados (DTO) do Votos
 *
 *
 */
class VotosDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o Votos
 *
 *
 */
class VotosADO extends BaseADO
{ 
    /**
