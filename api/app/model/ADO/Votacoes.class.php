...
/**
 * Classe de dados (DTO) do Votacoes
 *
 *
 */
class VotacoesDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o Votacoes
 *
 *
 */
class VotacoesADO extends BaseADO
{ 
    /**
