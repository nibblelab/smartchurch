...
/**
 * Classe de dados (DTO) do SalasEbd
 *
 *
 */
class SalasEbdDTO extends BaseDTO
{
    ...
    public $inicio;
    public $fim;
    public $atualizar_sumario;
    public $last_sumario_run;
    public $stat;
    public $time_cad;
    public $last_mod;
    public $last_amod;
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o SalasEbd
 *
 *
 */
class SalasEbdADO extends BaseADO
{ 
    /**
