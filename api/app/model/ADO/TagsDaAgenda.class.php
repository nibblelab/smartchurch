...
/**
 * Classe de dados (DTO) do TagsDaAgenda
 *
 *
 */
class TagsDaAgendaDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o TagsDaAgenda
 *
 *
 */
class TagsDaAgendaADO extends BaseADO
{ 
    /**
