...
/**
 * Classe de dados (DTO) do Eventos
 *
 *
 */
class EventosDTO extends BaseDTO
{
    ...
    public $ref;
    public $ref_tp;
    public $inscricoes_ativas;
    public $formulario_inscricao;
    public $valor;
    public $opcoes_pagto;
    public $lotes;
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o Eventos
 *
 *
 */
class EventosADO extends BaseADO
{ 
    /**
