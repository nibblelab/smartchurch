...
/**
 * Classe de dados (DTO) do ComissoesExecutivas
 *
 *
 */
class ComissoesExecutivasDTO extends BaseDTO
{
    /* dados propriamento ditos */
    public $id;
    public $gestao_inicio;
    public $gestao_fim;
    public $ref;
    public $ref_tp;
    public $stat;
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o ComissoesExecutivas
 *
 *
 */
class ComissoesExecutivasADO extends BaseADO
{ 
    /**
    ...
    {
        $this->dao = new ComissoesExecutivasDAO();
        $this->size = 0;
        $this->errs = array();
    }
