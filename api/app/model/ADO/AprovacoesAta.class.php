...
/**
 * Classe de dados (DTO) do AprovacoesAta
 *
 *
 */
class AprovacoesAtaDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o AprovacoesAta
 *
 *
 */
class AprovacoesAtaADO extends BaseADO
{ 
    /**
