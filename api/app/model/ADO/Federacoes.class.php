...
/**
 * Classe de dados (DTO) do Federacoes
 *
 *
 */
class FederacoesDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o Federacoes
 *
 *
 */
class FederacoesADO extends BaseADO
{ 
    /**
