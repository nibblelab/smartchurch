...
/**
 * Classe de dados (DTO) do Sociedades
 *
 *
 */
class SociedadesDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o Sociedades
 *
 *
 */
class SociedadesADO extends BaseADO
{ 
    /**
