...
/**
 * Classe de dados (DTO) do Contas
 *
 *
 */
class ContasDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o Contas
 *
 *
 */
class ContasADO extends BaseADO
{ 
    /**
