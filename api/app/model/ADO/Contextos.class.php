...
/**
 * Classe de dados (DTO) do Contextos
 *
 *
 */
class ContextosDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o Contextos
 *
 *
 */
class ContextosADO extends BaseADO
{ 
    /**
