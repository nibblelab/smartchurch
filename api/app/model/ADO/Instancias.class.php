...
/**
 * Classe de dados (DTO) do Instancias
 *
 *
 */
class InstanciasDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o Instancias
 *
 *
 */
class InstanciasADO extends BaseADO
{ 
    /**
