...
/**
 * Classe de dados (DTO) do Candidatos
 *
 *
 */
class CandidatosDTO extends BaseDTO
{
...
/**
 * Classe Façade que provê interface entre o DAO e o controller para o Candidatos
 *
 *
 */
class CandidatosADO extends BaseADO
{ 
    /**
