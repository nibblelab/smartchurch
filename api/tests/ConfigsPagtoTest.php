...
require_once  WS_PATH . '/configs_pagto.ws.php';
require_once ROOT_PATH . '/vendor/autoload.php';

use PHPUnit\Framework\TestCase;

/**
 * Classe para testar o service REST do ConfigsPagto
 */
class ConfigsPagtoTest extends TestCase
{
    /**
