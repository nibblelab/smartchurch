...
require_once  WS_PATH . '/aprovacoes_ata.ws.php';
require_once ROOT_PATH . '/vendor/autoload.php';

use PHPUnit\Framework\TestCase;

/**
 * Classe para testar o service REST do AprovacoesAta
 */
class AprovacoesAtaTest extends TestCase
{
    /**
