...
require_once  WS_PATH . '/pessoas_das_comissoes.ws.php';
require_once ROOT_PATH . '/vendor/autoload.php';

use PHPUnit\Framework\TestCase;

/**
 * Classe para testar o service REST do PessoasDasComissoes
 */
class PessoasDasComissoesTest extends TestCase
{
    /**
