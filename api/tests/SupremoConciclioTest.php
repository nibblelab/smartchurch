...
require_once  WS_PATH . '/supremo_conciclio.ws.php';
require_once ROOT_PATH . '/vendor/autoload.php';

use PHPUnit\Framework\TestCase;

/**
 * Classe para testar o service REST do SupremoConciclio
 */
class SupremoConciclioTest extends TestCase
{
    /**
