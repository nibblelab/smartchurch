...
require_once  WS_PATH . '/permissoes_do_perfil.ws.php';
require_once ROOT_PATH . '/vendor/autoload.php';

use PHPUnit\Framework\TestCase;

/**
 * Classe para testar o service REST do PermissoesDoPerfil
 */
class PermissoesDoPerfilTest extends TestCase
{
    /**
